...
idf.py bootloader
esptool.py --chip esp32 --before=default_reset --after=no_reset write_flash --flash_mode dio --flash_freq 40m --flash_size 4MB 0x0 /home/ndf/esp/bleuart/build/bootloader/bootloader-reflash-digest.bin --force
